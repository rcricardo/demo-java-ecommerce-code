						...
						<div class="filter-price p-t-22 p-b-50 bo3">
							...
							<div class="flex-sb-m flex-w p-t-16">
								...
								<div class="s-text3 p-t-10 p-b-10">
									Intervalo: R$<span id="value-lower">610</span> - R$<span id="value-upper">980</span>
								</div>
							</div>
						</div>
						...
						<div class="flex-w">
							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting">
									<option>Padr&atilde;o</option>
									<option>Popularidade</option>
									<option>Pre&ccedil;o: crescente</option>
									<option>Pre&ccedil;o: decrescente</option>
								</select>
							</div>

							<div class="rs2-select2 bo4 of-hidden w-size12 m-t-5 m-b-5 m-r-10">
								<select class="selection-2" name="sorting">
									<option>Pre&ccedil;o</option>
