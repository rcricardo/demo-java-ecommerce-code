					...
					<div class="p-r-50 p-r-0-lg">
						...
						<form class="leave-comment">
							...
							<p class="s-text8 p-b-40">
								Seu email n&atilde;o ser&aacute; publicado. Campos com * s&atilde;o obrigat&oacute;rios
							</p>

							<textarea class="dis-block s-text7 size18 bo12 p-l-18 p-r-18 p-t-13 m-b-20" name="comment" placeholder="Coment&aacute;rio..."></textarea>

							<div class="bo12 of-hidden size19 m-b-20">
								<input class="sizefull s-text7 p-l-18 p-r-18" type="text" name="name" placeholder="Nome *">
							</div>
							...
							<div class="bo12 of-hidden size19 m-b-30">
								<input class="sizefull s-text7 p-l-18 p-r-18" type="text" name="website" placeholder="Site">
							</div>
				...
				<div class="col-md-4 col-lg-3 p-b-80">
					<div class="rightbar">
						...
						<div class="pos-relative bo11 of-hidden">
							<input class="s-text7 size16 p-l-23 p-r-50" type="text" name="search-product" placeholder="Busca">
						...
						<ul class="bgwhite">
							<li class="flex-w p-b-20">
								<a href="product-detail.jsp" class="dis-block wrap-pic-w w-size22 m-r-20 trans-0-4 hov4">
									<img src="images/item-16.jpg" alt="IMG-PRODUCT">
								</a>

								<div class="w-size23 p-t-5">
									<a href="product-detail.jsp" class="s-text20">
